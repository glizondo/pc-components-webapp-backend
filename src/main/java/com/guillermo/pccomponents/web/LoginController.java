...
import com.guillermo.pccomponents.domain.AccountCredentials;
import com.guillermo.pccomponents.service.JwtService;
...
public class LoginController {
	...
	public ResponseEntity<?> getToken(@RequestBody AccountCredentials credentials) {
		...
		Authentication auth = authenticationManag.authenticate(creds);
